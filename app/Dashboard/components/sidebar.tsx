...
export default function Sidebar() {
    ...
    const menuItems = [
        ...
        { icon: <RiUserCommunityLine />, label: "Community", href: "/Community" },
        { icon: <GiDinosaurBones />, label: "Dino Info", href: "/Dino" },
    ];
    ...
    const itemClasses =
        "flex items-center px-4 py-2 cursor-pointer hover:bg-neutral-700 transition-colors duration-500 rounded-md";
